...
public class TambahTerapi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAMBAH TERAPI");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(270, 110, 180, 29);
        ...
        btn_simpan.setBounds(420, 480, 150, 45);
        ...
        btn_batal.setBounds(680, 480, 150, 45);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahTerapi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TambahTerapi().setVisible(true);
            }
        });
    }
